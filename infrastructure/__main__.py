...
task_def = aws.ecs.TaskDefinition(
    ...
    container_definitions=json.dumps([{
		"name": "my-app",
		"image": "134477770615.dkr.ecr.us-east-2.amazonaws.com/fastapi-repo-2998bb5:8b857d2fbf0236fba3be9ea5a7849e3f3ed4f29daa9fc6299d64e49dfe45881e", # a simple nginx example
		"portMappings": [{
			"containerPort": 8000,
			"hostPort": 80,
			"protocol": "tcp"
